...
export enum TransactionStatus {
  ...
  // Seller has dropped off goods at platform location
  GOODS_RECEIVED = 'GOODS_RECEIVED',
  
  // Dispatch rider assigned and goods in transit
  IN_DISPATCH = 'IN_DISPATCH',
  
  // Buyer has confirmed delivery
  DELIVERED = 'DELIVERED',
  
  // Payment released to seller (final state)
  COMPLETED = 'COMPLETED',
...
export interface AdminActionInput {
  transactionId: string;
  action: 'CONFIRM_PAYMENT' | 'CONFIRM_GOODS_RECEIVED' | 'ASSIGN_DISPATCH' | 'MARK_DISPATCHED' | 'RELEASE_PAYMENT';
  metadata?: Record<string, any>;
}
